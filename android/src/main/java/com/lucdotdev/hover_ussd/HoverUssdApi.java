...
public class HoverUssdApi {
    ...
    ///
        ...
        public void sendUssd(String action_id, HashMap<String, String> extra) {
            ...
            final HoverParameters.Builder builder = new HoverParameters.Builder(activity).request(action_id).setHeader("Processing... Please Wait").initialProcessingMessage("...").showUserStepDescriptions(true);
